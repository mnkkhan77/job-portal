...
const Privacy = () => {
  return (
    <>
      <BreadcrumbsNav path={["Home", "Privacy"]} />
      <Container maxWidth="md" sx={{ py: 6 }}>
        ...
        <Box sx={{ mt: 3 }}>
          ...
          <Typography variant="body2" paragraph>
            ...
            preferences when you register or apply for jobs through our
            platform.
          </Typography>
          ...
          <Typography variant="body2" paragraph>
            ...
            connect you with relevant employers. We do not sell your data to
            third parties.
          </Typography>
          ...
          <Typography variant="body2">
            ...
            contact us at <strong>privacy@jobportal.com</strong>.
          </Typography>
        </Box>
      </Container>
    </>
