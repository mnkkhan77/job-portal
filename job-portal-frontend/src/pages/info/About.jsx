...
const About = () => {
  return (
    <>
      <BreadcrumbsNav path={["Home", "About"]} />
      <Container maxWidth="md" sx={{ py: 6 }}>
        ...
        <Box sx={{ mt: 2 }}>
          <Typography variant="body1" paragraph>
            ...
            internship or your next big career move, we help you connect with
          ...
          <Typography variant="body1" paragraph>
            Built with React.js and Spring Boot, our platform ensures
            performance, security, and reliability at every step.
          </Typography>
        </Box>
      </Container>
    </>
